...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // validate: [validator.isAlpha, 'The name can only contain characters!'],
    },
    slug: { String },
    duration: {
      type: Number,
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message: 'The price (${VALUE}) discount has to be less than the total price',
      },
    },
    summary: {
      type: String,
...
//document middleware but only on .save .create
